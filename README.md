...
- [Investor matching](#investor-matching)
- [Trích xuất hồ sơ tự động](#trích-xuất-hồ-sơ-tự-động)
...
| Investor matching | Chấm fit score theo 9 chiều, confidence, lý do match/mismatch và recommended action dựa trên investment thesis |
| Trích xuất hồ sơ | Sinh candidate field từ tài liệu đã upload kèm evidence, startup xác nhận trước khi ghi vào draft |
