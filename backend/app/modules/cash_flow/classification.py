...
RULES = {
    CashActivity.FINANCING: ("vốn góp", "góp vốn", "đầu tư", "equity", "capital injection", "loan received", "vay", "giải ngân", "trả nợ gốc", "dividend", "hoàn vốn"),
    CashActivity.INVESTING: ("mua máy", "mua thiết bị", "capex", "tài sản cố định", "cải tạo", "xây dựng", "bán tài sản", "thanh lý"),
    CashActivity.OPERATING: ("bán hàng", "doanh thu", "khách hàng", "nguyên liệu", "nhà cung cấp", "tiền thuê", "lương", "điện", "nước", "internet", "marketing", "thuế", "phí", "lãi vay", "interest"),
}
