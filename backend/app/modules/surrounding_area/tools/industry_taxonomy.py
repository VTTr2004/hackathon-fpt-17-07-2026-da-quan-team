...
PROFILES: tuple[IndustryProfile, ...] = (
    IndustryProfile(
        ...
        keywords=("f&b", "fnb", "food", "restaurant", "nha hang", "quan an", "cafe", "ca phe",
                  "coffee", "an uong", "do uong", "tra sua", "bakery", "banh", "beverage", "bar", "pub"),
        competitor_tags=(("amenity", "cafe"), ("amenity", "restaurant"), ("amenity", "fast_food"),
                         ("amenity", "bar"), ("amenity", "pub"), ("amenity", "food_court"),
                         ("shop", "coffee"), ("shop", "bakery"), ("shop", "confectionery")),
        label_vi="Ẩm thực / F&B",
    ),
    IndustryProfile(
        key="retail",
        dependency=LocationDependency.PRIMARY,
        keywords=("retail", "ban le", "cua hang", "shop", "store", "sieu thi", "tap hoa",
                  "convenience", "minimart", "grocery", "thoi trang", "fashion", "boutique"),
        competitor_tags=(("shop", "convenience"), ("shop", "supermarket"), ("shop", "clothes"),
    ...
    IndustryProfile(
        key="education",
        dependency=LocationDependency.PRIMARY,
        keywords=("education", "giao duc", "truong", "trung tam", "day hoc", "tutor",
                  "language", "ngoai ngu", "training center", "mam non", "kindergarten"),
        competitor_tags=(("amenity", "school"), ("amenity", "language_school"),
                         ("amenity", "college"), ("amenity", "kindergarten"), ("amenity", "training")),
        label_vi="Giáo dục",
    ),
    IndustryProfile(
        key="healthcare",
        dependency=LocationDependency.PRIMARY,
        keywords=("clinic", "phong kham", "pharmacy", "nha thuoc", "dental", "nha khoa",
                  "y te", "healthcare", "benh vien", "hospital", "spa", "tham my"),
        competitor_tags=(("amenity", "clinic"), ("amenity", "pharmacy"), ("amenity", "doctors"),
                         ("amenity", "dentist"), ("amenity", "hospital"), ("shop", "beauty"),
                         ("shop", "chemist"), ("leisure", "spa")),
    ...
    IndustryProfile(
        ...
        competitor_tags=(("tourism", "hotel"), ("tourism", "hostel"), ("tourism", "guest_house"),
    ...
    IndustryProfile(
        ...
        keywords=("logistics", "van tai", "kho", "warehouse", "manufacturing", "san xuat",
                  "nha may", "factory", "coworking", "khu cong nghiep"),
        competitor_tags=(),
    ...
    IndustryProfile(
        ...
        keywords=("saas", "software", "phan mem", "fintech", "cong nghe", "app", "platform",
                  "marketplace", "ai", "blockchain", "e-commerce", "thuong mai dien tu",
                  "edtech", "web", "digital", "startup cong nghe", "api"),
        competitor_tags=(),
    ...
    if explicit is not None:
        ...
        if dep is not None:
            return ClassificationResult(
                ...
                label_vi={"primary": "Phụ thuộc vị trí (chỉ định)",
                          "supporting": "Vị trí phụ trợ (chỉ định)",
                          "independent": "Không phụ thuộc vị trí (chỉ định)"}[dep.value],
