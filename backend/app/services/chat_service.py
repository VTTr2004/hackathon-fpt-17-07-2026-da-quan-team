...
def startup_profile(source: Any) -> dict[str, Any]:
    """Build the RAG profile payload from a live Startup or submitted snapshot."""
    ...
    return {
        ...
        "stage": read("stage"),
        "primary_location": read("primary_location"),
        "facts": read("facts", {}) or {},
    }
