          ...
          <main className="deskMain">
            ...
            <div className="deskPanel" hidden={activeTab !== "evidence"}>
              <section className="hdCard" id="startup-documents">
                ...
                {editable && <form className="uploadBox" onSubmit={upload}><input name="document" type="file" accept=".pdf,.docx,.pptx,.xlsx,.txt,.md,.csv" required /><button className="hdBtn primary" disabled={busy === "upload"}><MIcon name="upload" />Tải lên</button></form>}
